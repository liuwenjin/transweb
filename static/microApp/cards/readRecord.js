  ...
  task: {
    ...
    option: {
      ...
      template: "<div style='position: relative; width: 100%; height: 100%;'><div style='float: left; width: 60px; height: 100%; border: solid 1px #f2f2f2;'></div>\
                  ...
                  <p style='margin: 0px;'><label style='margin: 0px;'>进度: <span>2/25</span></label><label style='margin: 0px; float: right;'>最近时间: <span>{{time}}</span></label></p><h3 style='width: 100%; margin: 0px; font-size: 14px;'>{{title}}</h3><p style='margin: 0px;'>作者:<span>{{author}}</span></p>\
                  </div></div>",
      style: {
